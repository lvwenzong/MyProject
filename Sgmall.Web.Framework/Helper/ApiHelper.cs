...
namespace Sgmall.Web.Framework
{
    public class ApiHelper
    {
        ...
        public static void CheckBaseParamsAndSign(SortedDictionary<string, string> data)
        {
            if (data == null)
            {
                throw new SgmallApiException(ApiErrorCode.System_Error, "no params");
            }
            if (data.Count < 1)
            {
                throw new SgmallApiException(ApiErrorCode.System_Error, "no params");
            ...
            {
                throw new SgmallApiException(ApiErrorCode.Missing_Timestamp, "timestamp");
            }
            ...
            {
                throw new SgmallApiException(ApiErrorCode.Invalid_Timestamp, "timestamp");
            }
            if (!data.TryGetValue("sign", out sign))
            {
                throw new SgmallApiException(ApiErrorCode.Missing_Signature, "sign");
            }
            ...
            {
                throw new SgmallApiException(ApiErrorCode.Invalid_Signature, "sign");
            }
        }
