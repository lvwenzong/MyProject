...
namespace Sgmall.Web.Framework
{
    public class OpenAPIHelper
    {
        ...
        public static void CheckBaseParamsAndSign(SortedDictionary<string, string> data)
        {
            if (data == null)
            {
                throw new SgmallApiException(Sgmall.Open.Api.OpenApiErrorCode.System_Error, "no params");
            }
            if (data.Count < 1)
            {
                throw new SgmallApiException(Sgmall.Open.Api.OpenApiErrorCode.System_Error, "no params");
            ...
            {
                throw new SgmallApiException(Sgmall.Open.Api.OpenApiErrorCode.Missing_App_Key, "app_key");
            }
            ...
            {
                throw new SgmallApiException(Sgmall.Open.Api.OpenApiErrorCode.Missing_Timestamp, "timestamp");
            }
            ...
            {
                throw new SgmallApiException(Sgmall.Open.Api.OpenApiErrorCode.Invalid_Timestamp, "timestamp");
            }
            if (!data.TryGetValue("sign", out sign))
            {
                throw new SgmallApiException(Sgmall.Open.Api.OpenApiErrorCode.Missing_Signature, "sign");
            }
            ...
            {
                throw new SgmallApiException(Sgmall.Open.Api.OpenApiErrorCode.Invalid_Signature, "sign");
            }
        }
